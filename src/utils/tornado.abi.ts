const TornadoProxyABI = [
  {
    inputs: [
      { internalType: 'address', name: '_tornadoTrees', type: 'address' },
  ...
  {
    inputs: [
      { internalType: 'contract ITornadoInstance', name: '', type: 'address' },
    ],
    name: 'instances',
    outputs: [
      { internalType: 'bool', name: 'isERC20', type: 'bool' },
  ...
  },
  {
    ...
    name: 'tornadoTrees',
    outputs: [
      { internalType: 'contract ITornadoTrees', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
export default TornadoProxyABI;
